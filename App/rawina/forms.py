...
class NarratorSetupForm(forms.Form):
    ...
    character_type = forms.CharField(label="Character Type", max_length=100, help_text="e.g., a brave child, a clever fox...")
    setting = forms.CharField(label="Setting", max_length=100, help_text="e.g., an enchanted forest, a flying train...")
    theme = forms.CharField(label="Theme", max_length=100, help_text="e.g., adventure, friendship, courage...")
